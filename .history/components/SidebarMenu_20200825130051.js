...
import subCountyAdminRoutes from "../lib/subCountyAdminRoutes";
import wardAdminRoutes from "../lib/wardAdminRoutes";
...
import departmentOfficialRoutes from "../lib/departmentOfficialRoutes";
          ...
          <span>
            ...
            <Avatar
              ...
              src={`https://ui-avatars.com/api/?name=${
                !global.isLoadingState && user ? user.fname : ""
              }+${
                !global.isLoadingState && user ? user.lname : ""
...
export default withRouter(withGlobalContext(SidebarContent));
