...
const CollectionCreateForm = Form.create({ name: "form_in_modal" })(
  ...
  class extends React.Component {
    ...
    render() {
      ...
      // const images = [{ url: "https://source.unsplash.com/random/800X600" }];
      return (
        <Modal
          visible={visible}
        ...
        >
          <div>
            {this.state.data && this.state.data.images.length > 0 > 0 && (
              <SimpleImageSlider
                width={896}
                height={504}
                images={this.state.data ? this.state.data.images : null}
              />
            )}
          </div>
