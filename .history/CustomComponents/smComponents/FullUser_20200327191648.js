          ...
          >
            <TabPane tab="Details" key="1">
              <Descriptions size={"small"} bordered>
                ...
                {(role == "sub-county-admin" || role == "ward-admin") && (
                  <>
                    <Descriptions.Item label="County" span={3}>
                      <Capitalize text={county} />
                    </Descriptions.Item>{" "}
                    <Descriptions.Item label="Sub County" span={3}>
                      <Capitalize text={subCounty} />
                    </Descriptions.Item>{" "}
                    {role == "ward-admin" && (
                      <Descriptions.Item label="Ward" span={3}>
                        <Capitalize text={ward} />
                      </Descriptions.Item>
                    )}
                  </>
                )}
            ...
            <TabPane tab="Actions" key="2"></TabPane>
          </Tabs>
        </Modal>
      );
    }
